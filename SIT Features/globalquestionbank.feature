Feature: Global question bank feature
  
  Scenario: verify adding eassy ,vedio ,mcq type questions to Global question bank
  ...
  And navigate to the global question bank
